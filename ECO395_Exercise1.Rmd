...
#read in data
ABIA <- read.csv('~/ECO395M_/data/ABIA.csv')
```
...
#read in data
billboard <- read.csv('~/ECO395M_/data/billboard.csv')
```
Part A
...
#read in data
olympics <- read.csv('~/ECO395M_/data/olympics_top20.csv')
```
PART A
...
#read in data
sclass <- read.csv('~/ECO395M_/data/sclass.csv')
